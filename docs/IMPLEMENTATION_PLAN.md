...
```text
pyproject.toml
src/aelia/__init__.py
src/aelia/app/config.py
src/aelia/contracts/common.py
src/aelia/contracts/events.py
src/aelia/contracts/traces.py
src/aelia/persona/models.py
src/aelia/persona/loader.py
src/aelia/persona/source/*
src/aelia/runtime/orchestrator.py
src/aelia/runtime/replay.py
src/aelia/storage/database.py
src/aelia/storage/migrations.py
src/aelia/storage/repositories.py
src/aelia/cli.py
