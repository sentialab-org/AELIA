...
from aelia.models.prompt import (
...
LANGUAGE_REALIZATION_PROMPT: Final = PromptDefinition(
    ...
    owner="aelia-language-boundary",
    input_schema="aelia.contracts.actions.OutboundAction@2.2.0",
    output_schema="aelia.contracts.actions.LanguageGenerationResult@2.3.0",
    parts=(
        PromptTemplatePart(
