...
from polyverse.app.config import Settings, load_settings
from polyverse.app.logging import get_logger
from polyverse.backend.application import RuntimeApplication, RuntimeProtocolError
from polyverse.contracts.adapter import AdapterInboundEnvelope
from polyverse.contracts.connector import ExternalDeliveryReceipt
from polyverse.contracts.runtime_api import (
...
def create_app(
    ...
    *,
    ...
    app = FastAPI(
        title="Polyverse Runtime Backend",
    ...
    async def protocol_boundaries(
        ...
        response.headers["x-polyverse-runtime-api-version"] = RuntimeApplication.API_VERSION
        return response
